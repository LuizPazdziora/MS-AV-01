...
CREATE TABLE playlist_musicas (
    ...
    UNIQUE (playlistid, musicaid), FOREIGN KEY (musicaid) REFERENCES musicas(id) ON DELETE CASCADE);
...
CREATE TABLE reproducoes (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    playlistid INT NOT NULL,
    datahora TIMESTAMP NOT NULL, FOREIGN KEY (playlistid) REFERENCES playlists(id) ON DELETE CASCADE
);
